# ----------------------------------------------------------
# 🔥 Erdgas Trend Forecast + Parameteroptimierung (final)
# ----------------------------------------------------------
...
# ⚙️ Parameter
# ----------------------------------------------------------
SYMBOL = "NG=F"       # Natural Gas Futures (NYMEX)
OIL_SYMBOL = "CL=F"   # Crude Oil Futures (WTI)
...
def load_data(ticker, oil_ticker):
    ...
    if oil.empty:
        raise ValueError(f"Fehler: Keine Daten für {oil_ticker} gefunden.")
...
def add_indicators(df):
    ...
    # Sicherstellen, dass High/Low existieren
